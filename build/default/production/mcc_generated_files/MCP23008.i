# 1 "mcc_generated_files/MCP23008.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/MCP23008.c" 2
...
# 2 "mcc_generated_files/MCP23008.c" 2
...
void MCP23008_Output(unsigned int condition)
{
    I2C_Open(0x40);
        ...
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,0x18,1);
        I2C_WriteNBytes(0x40,0xFF,1);
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,0x00,1);
        I2C_WriteNBytes(0x40,condition,1);
        I2C_Close();
# 54 "mcc_generated_files/MCP23008.c"
}
